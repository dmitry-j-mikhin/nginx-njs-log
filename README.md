...
[nginx:1.26.2](https://hub.docker.com/_/nginx/)
...
```
Latest log record formatted with [jq](https://github.com/jqlang/jq) can be viewed with command `docker logs --tail 1 nginx-njs-log | jq`:
```JSON
{
  "source": "nginx",
  "msec": 1690974762.229,
